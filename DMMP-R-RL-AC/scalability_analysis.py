...
def run_scalability_analysis(task_counts=None, runs_per_setting=RUNS_PER_SETTING):
    ...
    original_num_tasks = config.NUM_TASKS
    ...
    try:
        ...
        config.NUM_TASKS = original_num_tasks

    _save_plot(results, results["completion_rate"], "Completion Rate (%)", "scalability_completion_rate.png")
    _save_plot(
        results,
    ...
    _save_plot(results, results["travel_distance"], "Travel Distance", "scalability_travel_distance.png")
    _save_plot(results, results["energy_utilisation"], "Energy Utilisation (%)", "scalability_energy_utilisation.png")
    _save_plot(results, results["compute_utilisation"], "Compute Utilisation (%)", "scalability_compute_utilisation.png")
    _save_plot(results, results["fairness"], "Jain Fairness Index", "scalability_fairness.png")
    _save_plot(results, results["overloaded"], "Overloaded UAV Count", "scalability_overloaded_uavs.png")
