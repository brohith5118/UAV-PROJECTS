...
# Reward coefficients for normalized TSA features.
CD = -160.0  # distance penalty over map diagonal
CP =  90.0   # priority reward
CT =  45.0   # deadline slack / endurance reward
CC =  25.0   # compute sufficiency reward
